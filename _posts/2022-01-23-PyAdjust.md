...
{:refdef: style="text-align: center;"}
![Before]({{ site.url }}/GayMePy/images/before.png "Before adjustment."){:height="25%" width="25%" float: left}![Before]({{ site.url }}/GayMePy/images/after.png "After adjustment."){:height="25%" width="25%" float: right}
